...
export const metadata = pageMetadata({
  title: "FPL Prism — Terms of Use",
  description: "Terms for using FPL Prism as an independent Fantasy Premier League analytics project.",
  path: "/terms",
});
  ...
  return (
    <main className="legal-shell">
      ...
      <article className="legal-card">
        ...
        <p>Projections, recommendations, chip assessments, probabilities and simulations are estimates. Football outcomes, player availability, tactical decisions and official game rules can change. FPL Prism does not guarantee points, rank improvement, financial value or any particular result.</p>
        ...
        <p>An FPL Prism account is optional. Guest access remains available for the current launch product. If you create an account, you are responsible for keeping your sign-in credentials secure and for providing accurate information. Do not share your FPL Prism password or use another person&apos;s account without permission.</p>
        ...
        <p>Fantasy Premier League, Premier League names, club names, competition marks and associated intellectual property belong to their respective owners. FPL Prism does not claim ownership of those third-party rights. Current and historical data may originate from third-party services and remain subject to the rights and terms of their respective owners.</p>

        <h2>Acceptable use</h2>
        <p>Do not attempt to abuse, overload, scrape, reverse-engineer, interfere with or gain unauthorized access to FPL Prism, another user&apos;s account or its infrastructure. Do not use the service to submit unlawful or sensitive data.</p>
        ...
        <p>FPL Prism currently uses an explainable statistical recommendation engine. The in-product Model page describes major inputs, assumptions and known limitations. The word “AI” does not mean the output is certain or human-reviewed.</p>
        ...
        <p>These terms may be updated as FPL Prism changes. Continued use after a material update means you are using the service under the revised terms.</p>
      </article>
    </main>
  );
}
