  ...
  return (
    <main className="legal-shell">
      ...
      <article className="legal-card">
        ...
        <p>Do not attempt to abuse, overload, scrape, reverse-engineer, interfere with or gain unauthorized access to FPL Risk or its infrastructure. Do not use the service to submit unlawful or sensitive data.</p>

        <h2>Availability</h2>
        <p>The service may be changed, suspended or unavailable without notice, including when an upstream data source is unavailable or changes its interface. We may change the model as we test and calibrate it.</p>

        <h2>Accounts, purchases and cancellation</h2>
        <p>There are currently no FPL Risk accounts, paid plans, automatic renewals or purchases. Therefore there is currently nothing to cancel and no recurring charge. New commercial features will require updated terms before release.</p>
